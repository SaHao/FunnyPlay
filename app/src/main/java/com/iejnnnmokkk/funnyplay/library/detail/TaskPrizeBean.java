...
/**
 * @author Sun
 * @Demo class TaskPrizeBean
 * @Description TODO
 * @date 2024/12/30 10:47
 */
public class TaskPrizeBean extends BaseBean {
    ...
    static class Step {
        ...
        // Getters and Setters
        public List<AdCallback> getAd_callback() {
            return ad_callback;
        }

        public void setAd_callback(List<AdCallback> ad_callback) {
    ...
    static class AdCallback {
        ...
        public List<AdCallbackData> getData() {
            return data;
        }

        public void setData(List<AdCallbackData> data) {
            this.data = data;
        }
    }
