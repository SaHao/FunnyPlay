...
public class GamePlayBean extends BaseBean {
   ...
   public static class DataBean {
        ...
        private int red;
        private int img_num;
        private List<String> img_example;
        private List<String> img_example_url;
        ...
        public List<String> getImg_example() {
            return img_example;
        }

        public void setImg_example(List<String> img_example) {
            this.img_example = img_example;
        }

        public List<String> getImg_example_url() {
            return img_example_url;
        }

        public void setImg_example_url(List<String> img_example_url) {
    ...
    public static class Step {
        ...
        // Getters and Setters
        public List<AdCallback> getAd_callback() { return ad_callback; }
   ...
   public static class AdCallback {
        ...
        public List<AdCallbackData> getData() { return data; }
        public void setData(List<AdCallbackData> data) { this.data = data; }
    }

    static class AdCallbackData {
    ...
    static class AllBean {
        ...
        public String getServer_name() { return server_name; }
        public void setServer_name(String server_name) { this.server_name = server_name; }
        public List<AllDataBean> getData() { return data; }
        public void setData(List<AllDataBean> data) { this.data = data; }
    }

    static class AllDataBean {
        private String title;
        private int condition;
        private int reward;
        private int status;
